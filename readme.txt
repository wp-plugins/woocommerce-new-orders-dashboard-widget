...
1. Upload woocommerce New Orders Dashboard Widget to the `/wp-content/plugins/` directory
...
1. Woocommerce New Order's Dashboard Widget 1

2. Woocommerce New Order's Dashboard Widget 2
